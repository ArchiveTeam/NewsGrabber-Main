...
class RunServices(threading.Thread):
    ...
    def refresh_services(self):
        if os.path.isdir('services'):
            shutil.rmtree('services')
        os.system('git clone https://github.com/ArchiveTeam/NewsGrabber-Services.git')
        shutil.copytree(os.path.join('NewsGrabber-Services', 'services'), 'services')
        shutil.rmtree('NewsGrabber-Services')
        reload(services)
        self.start_services()
